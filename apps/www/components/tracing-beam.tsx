    ...
    >
      ...
      >
        <motion.div
          ...
          className="ml-[27px] flex h-4 w-4 items-center justify-center rounded-full border border-muted"
        >
          <motion.div
            transition={{
              duration: 0.2,
            ...
            className="h-2 w-2 rounded-full border border-muted bg-primary"
          />
        </motion.div>
        <svg
