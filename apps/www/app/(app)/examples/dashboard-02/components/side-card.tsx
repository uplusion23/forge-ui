...
import { ChevronLeft, ChevronRight, Copy, CreditCard, MoreVerticalIcon, Truck } from "lucide-react";
...
function SideCard() {
  return (
    <Card className="row-span-3 overflow-hidden">
      <CardHeader className="flex flex-col items-start gap-4 bg-muted/50">
